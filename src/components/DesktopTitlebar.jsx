    ...
    return (
        <div className={`window-titlebar ${!user ? 'login-mode' : ''}`}>
            <div className="window-titlebar-left">
                {user && (
                    <>
                        <span className="window-titlebar-title" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}>
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
